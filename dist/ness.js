...
function initBars() {
  ...
  if (ness_bars.length) {
    ...
    try {
      for (var _iterator = ness_bars[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        var ness_bar = _step.value;
...
function initMasks() {
  ...
  if (masks.length) {
    var parent_css = { position: 'relative' };
    var children_css = { zIndex: '2' };
    var _iteratorNormalCompletion2 = true;
    var _didIteratorError2 = false;
    var _iteratorError2 = undefined;

    try {
      for (var _iterator2 = masks[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
